package com.moneybook.api.global.auth.filter;
...
public class LoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public LoginFilter(ObjectMapper objectMapper, AuthenticationManager authenticationManager,
        ...
        super(new AntPathRequestMatcher("/api/user/login", HttpMethod.POST.name())); // 위에서 설정한 "login" + POST로 온 요청을 처리하기 위해 설정
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        UserLoginRequest loginRequestDto = objectMapper.readValue(messageBody,
            UserLoginRequest.class);

        Set<ConstraintViolation<UserLoginRequest>> violations = Validation.buildDefaultValidatorFactory()
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request,
        ...
        log.error("사용자 로그인 인증 실패: {}", failed.getMessage(), failed);
